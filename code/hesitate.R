...
ggplot() +
  ...
  geom_ellipse(aes(x0 = 0,  y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#DAD8DB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#D8D6D9", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 32.6, a = 1, b = 0.17, angle = pi), fill = "#D0CED3", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 2,  y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#DAD8DB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 33, a = 1, b = 0.17, angle = pi), fill = "#D8D6D9", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#DAD8DB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 33.4, a = 1, b = 0.17, angle = pi), fill = "#D8D6D9", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 2,  y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 34, a = 1, b = 0.2, angle = pi), fill = "#D8D6D9", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#B1B4B9", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 34.8, a = 1, b = 0.3, angle = pi), fill = "#D8D6D9", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 2,  y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#B1B4B9", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 35.6, a = 1, b = 0.4, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#B1B4B9", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 36.4, a = 1, b = 0.5, angle = pi), fill = "#D2D0D5", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 2,  y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#B1B4B9", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 37.4, a = 1, b = 0.6, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#D3D1D2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 38.8, a = 1, b = 0.7, angle = pi), fill = "#B5B6BB", color = "#F1ECE6") +
  
  geom_ellipse(aes(x0 = 2,  y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#D3D1D2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 40.2, a = 1, b = 0.8, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#D9D8D6", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#D3D1D2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 42, a = 1, b = 0.9, angle = pi), fill = "#5B5C61", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 2,  y0 = 44, a = 1, b = 1, angle = pi), fill = "#D9D8D6", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 6,  y0 = 44, a = 1, b = 1, angle = pi), fill = "#D3D1D2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 10, y0 = 44, a = 1, b = 1, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 14, y0 = 44, a = 1, b = 1, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 18, y0 = 44, a = 1, b = 1, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 22, y0 = 44, a = 1, b = 1, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 26, y0 = 44, a = 1, b = 1, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 30, y0 = 44, a = 1, b = 1, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 34, y0 = 44, a = 1, b = 1, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 38, y0 = 44, a = 1, b = 1, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 42, y0 = 44, a = 1, b = 1, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 46, y0 = 44, a = 1, b = 1, angle = pi), fill = "#474A4F", color = "#F1ECE6") +

  geom_ellipse(aes(x0 = 0,  y0 = 46, a = 1, b = 1, angle = pi), fill = "#E3DFDC", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 4,  y0 = 46, a = 1, b = 1, angle = pi), fill = "#D9D8D6", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 8,  y0 = 46, a = 1, b = 1, angle = pi), fill = "#D3D1D2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 12, y0 = 46, a = 1, b = 1, angle = pi), fill = "#C2C2C4", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 16, y0 = 46, a = 1, b = 1, angle = pi), fill = "#9D9CA2", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 20, y0 = 46, a = 1, b = 1, angle = pi), fill = "#74757A", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 24, y0 = 46, a = 1, b = 1, angle = pi), fill = "#5A5B5F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 28, y0 = 46, a = 1, b = 1, angle = pi), fill = "#4F4E53", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 32, y0 = 46, a = 1, b = 1, angle = pi), fill = "#4B464D", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 36, y0 = 46, a = 1, b = 1, angle = pi), fill = "#414143", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 40, y0 = 46, a = 1, b = 1, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 44, y0 = 46, a = 1, b = 1, angle = pi), fill = "#4A494E", color = "#F1ECE6") +
  geom_ellipse(aes(x0 = 48, y0 = 46, a = 1, b = 1, angle = pi), fill = "#474A4F", color = "#F1ECE6") +
  
  theme_void() +
  theme(
    plot.background = element_rect(fill = "#F1ECE6", color = "#F1ECE6"),
